...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblAddBooks.setForeground(new Color(2, 52, 63));
		lblAddBooks.setFont(new Font("Tahoma", Font.BOLD, 18));
		...
		btnAddBooks.setBackground(new Color(14, 131, 136));
		btnAddBooks.setForeground(new Color(44, 51, 51));
		...
		btnBack.setBackground(new Color(14, 131, 136));
		btnBack.setForeground(new Color(44, 51, 51));
